...
namespace InsanKaynaklariYonetimiPlatformu.UI.Controllers
{
    public class AdminController : Controller
    {
        ...
        public AdminController(IAdminService adminserv, IEmployeeService employeeService, IManagerService managerService)
        {
            adminService = adminserv;
            _employeeService = employeeService;
            _managerService = managerService;
        }
        public IActionResult Index(IndexVM indexVms)
        {
            if (indexVms != null)
            {
                indexVms.EmployeeCount = _employeeService.AmountEmployee();
                indexVms.CompanyCount = _managerService.AmountCompany();
                indexVms.ManagerCount = _managerService.AmountCompany();
            }
